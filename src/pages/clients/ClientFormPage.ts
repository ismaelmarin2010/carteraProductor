...
export interface ClientFormPageOptions {
    onSubmit: (input: CreateClientInput) => void;
}

export function createClientFormPage({
    onSubmit
}: ClientFormPageOptions): HTMLElement {
    ...
    const identificationTypeContainer =
    ...
    const identificationOptions: Array<{
    ...
    identificationTypeContainer.append(
    ...
    form.addEventListener("submit", (event) => {
        ...
        const firstNameInput =
            firstNameField.querySelector<HTMLInputElement>("input");

        const lastNameInput =
            lastNameField.querySelector<HTMLInputElement>("input");

        const identificationNumberInput =
            identificationNumberField.querySelector<HTMLInputElement>(
                "input"
            );

        const emailInput =
            emailField.querySelector<HTMLInputElement>("input");

        const phoneInput =
            phoneField.querySelector<HTMLInputElement>("input");
        ...
        const input: CreateClientInput = {
            ...
            lastName,
            identificationType:
                identificationTypeSelect.value as IdentificationType,
